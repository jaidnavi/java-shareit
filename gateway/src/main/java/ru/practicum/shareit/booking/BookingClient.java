...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> addBooking(BookingRequestDTO bookingDTO, Long renterId) {
        return post("", renterId, bookingDTO);
    }

    public ResponseEntity<Object> confirmOrReject(Long bookingId, Long itemOwnerId, Boolean approved) {
    ...
    public ResponseEntity<Object> getAllBookingByOwnerId(Long currentUserId, StateEnum state) {
        Map<String, Object> parameters = Map.of("state", state);
        return get("/owner?state={state}", currentUserId, parameters);
    }
}
